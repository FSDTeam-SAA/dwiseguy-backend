...
router.post('/start-instrument', progressController.startInstrument);

// Student views the instrument curriculum (with lock/unlock logic)
router.get('/instrument-details/:instrumentId', progressController.getStudentInstrumentDetails);

// Get the specific lesson the user left off at
router.get('/resume/:instrumentId', progressController.resumeInstrument);
